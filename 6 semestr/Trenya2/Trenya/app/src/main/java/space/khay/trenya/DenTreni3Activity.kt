...
class DenTreni3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = getSharedPreferences("ExercisePreferences_DenTreni3", MODE_PRIVATE)
    ...
    private fun startExerciseActivity(exercises: List<Exercise>, currentIndex: Int) {
        val intent = Intent(this, ExerciseActivity3::class.java)
    ...
    private fun displayExercises(exercises: List<Exercise>) {
        ...
        recyclerViewExercises.layoutManager = LinearLayoutManager(this@DenTreni3Activity)
        ...
        continueButton.setOnClickListener {
            val sharedPreferences = getSharedPreferences("ExercisePreferences_DenTreni3", MODE_PRIVATE)
