...
class ExerciseActivity2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onCancelled(databaseError: DatabaseError) {
                Toast.makeText(this@ExerciseActivity2, "Ошибка загрузки данных: ${databaseError.message}", Toast.LENGTH_SHORT).show()
            }
        })
    ...
    private fun showExercise(index: Int) {
        ...
        val sharedPreferences: SharedPreferences = getSharedPreferences("ExercisePreferences_DenTreni2", MODE_PRIVATE)
    ...
    private fun finishActivity() {
        ...
        val sharedPreferences = getSharedPreferences("ExercisePreferences_DenTreni2", MODE_PRIVATE)
