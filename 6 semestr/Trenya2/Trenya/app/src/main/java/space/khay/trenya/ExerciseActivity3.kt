...
class ExerciseActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onCancelled(databaseError: DatabaseError) {
                Toast.makeText(this@ExerciseActivity3, "Ошибка загрузки данных: ${databaseError.message}", Toast.LENGTH_SHORT).show()
            }
        })
    ...
    private fun showExercise(index: Int) {
        ...
        val sharedPreferences: SharedPreferences = getSharedPreferences("ExercisePreferences_DenTreni3", MODE_PRIVATE)
