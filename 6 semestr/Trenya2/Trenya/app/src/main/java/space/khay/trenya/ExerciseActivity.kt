...
class ExerciseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onCancelled(databaseError: DatabaseError) {
                Toast.makeText(this@ExerciseActivity, "Ошибка загрузки данных: ${databaseError.message}", Toast.LENGTH_SHORT).show()
            }
        })
    ...
    private fun showExercise(index: Int) {
        ...
        exerciseRepetitionsTextView.text = "Количество повторений: $currentRepetitions"
