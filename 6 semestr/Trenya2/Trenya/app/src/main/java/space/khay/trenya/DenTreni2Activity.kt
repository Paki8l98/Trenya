...
class DenTreni2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = getSharedPreferences("ExercisePreferences_DenTreni2", MODE_PRIVATE)
    ...
    private fun displayExercises(exercises: List<Exercise>) {
        ...
        recyclerViewExercises.layoutManager = LinearLayoutManager(this@DenTreni2Activity)
